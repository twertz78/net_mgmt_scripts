...
if MAC_VALID.match(MAC) is None:
	...
	try:
		...
		print str(MAC) + " was found on " + str(switch_name) + " on " + str(switch_port),
...
net_connect=ConnectHandler(device_type='cisco_ios', ip=switch_name, username=USERNAME, password=PASSWORD, secret='xB1iWoMlYQ0Qv9awLNOM1')
net_connect.enable()
